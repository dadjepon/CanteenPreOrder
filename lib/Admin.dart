...
import 'package:canteen_preorderapp/ViewAllUSer.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:canteen_preorderapp/auth_controller.dart';
...
ElevatedButton(
  onPressed: () {
    Get.to(() => const UserListScreen()); // Navigate to UserListScreen
  },
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                ...
                TextField(controller: roleController, decoration: const InputDecoration(hintText: 'Role')),
              ],
            ),
          ),
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                _createNewUser(nameController.text, emailController.text, passwordController.text, roleController.text);
                Navigator.of(context).pop();
              },
            ),
          ],
...
void _createNewUser(String name, String email, String password, String role) async {
  try {
...
class User {
  ...
  factory User.fromFirestore(DocumentSnapshot doc) {
    ...
    return User(
      ...
      email: data['email'] ?? 'No Email', // Default value if 'email' is not found
